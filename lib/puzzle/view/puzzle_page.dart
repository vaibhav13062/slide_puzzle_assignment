...
class InputWidget extends StatefulWidget {
  final Function(int sizeX, int sizeY) onSubmit;
...
class _InputWidgetState extends State<InputWidget> {
  int _currentValueX = 3;
  int _currentValueY = 3;
  @override
  Widget build(BuildContext context) {
    return Container(
        ...
        BlocListener<DashatarThemeBloc, DashatarThemeState>(
          ...
          MultiBlocProvider(
            providers: [
              ...
              BlocProvider(
                create: (context) => PuzzleBloc(sizeXX!, sizeYY!)
                  ..add(
                    PuzzleInitialized(
...
class PuzzleBoard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final sizeX = puzzle.getDimensionX();
    final sizeY = puzzle.getDimensionY();
    if (sizeX == 0 || sizeY == 0) return const CircularProgressIndicator();

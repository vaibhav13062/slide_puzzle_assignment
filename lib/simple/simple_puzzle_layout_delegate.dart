...
class SimplePuzzleLayoutDelegate extends PuzzleLayoutDelegate {
  ...
  @override
  Widget boardBuilder(int sizeX, int sizeY, List<Widget> tiles) {
    return Column(
      children: [
        const ResponsiveGap(
          small: 32,
...
class SimplePuzzleBoard extends StatelessWidget {
  ...
  /// The sizeX of the board.
  final int sizeX;
  /// The sizeY of the board.
  final int sizeY;

...
class Puzzle extends Equatable {
  /// {@macro puzzle}
  const Puzzle({required this.tiles,required this.sizeX, required this.sizeY, });
  ...
  Puzzle _swapTiles(List<Tile> tilesToSwap) {
    ...
    return Puzzle(tiles: tiles, sizeX: sizeX, sizeY: sizeY);
  }
  ...
  Puzzle sort() {
    ...
    return Puzzle(tiles: sortedTiles,sizeX: sizeX, sizeY: sizeY);
  }

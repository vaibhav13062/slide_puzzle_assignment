...
class DashatarPuzzleTileState extends State<DashatarPuzzleTile>
  ...
  Widget build(BuildContext context) {
    final sizeX = widget.state.puzzle.getDimensionX();
    final sizeY = widget.state.puzzle.getDimensionY();
    ...
    return AudioControlListener(
      ...
      child: AnimatedAlign(
        alignment: FractionalOffset(
          (widget.tile.currentPosition.x - 1) / (sizeX - 1),
          (widget.tile.currentPosition.y - 1) / (sizeY - 1),
        ),
